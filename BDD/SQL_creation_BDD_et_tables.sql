...
CREATE DATABASE fruitful CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE=InnoDB;
...
CREATE TABLE entree_agenda_evenement(
	...
	FOREIGN KEY (i_id_evenement) REFERENCES type_evenement (i_id_evenement)
);
