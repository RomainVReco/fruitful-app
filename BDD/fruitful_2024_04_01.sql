...
ALTER TABLE `utilisateur`
  ADD CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`idAdresse`) REFERENCES `adresse` (`idAdresse`);
...
ALTER TABLE `evenement`
  ...
  ADD CONSTRAINT `evenement_ibfk_5` FOREIGN KEY (`idObjectif`) REFERENCES `objectif` (`idObjectif`);
