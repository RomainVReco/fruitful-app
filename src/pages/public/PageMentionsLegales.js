...
function MentionsLegales() {
  return (
    <div className="mentions-legales-bordure">
      ...
      <p>
        <strong>Nom de l'entreprise :</strong> Fruitful Coaching Numérique SARL<br />
        <strong>Forme juridique :</strong> SARL<br />
        <strong>Adresse :</strong> 123 Rue des Fruits, 75000 Paris, France<br />
        <strong>Téléphone :</strong> +33 1 23 45 67 89<br />
        <strong>E-mail :</strong> contact@fruitfulcoaching.com<br />
        <strong>Capital social :</strong> 50 000 euros<br />
        <strong>RCS :</strong> 123456789 (Paris)<br />
      ...
      <h2>Hébergement</h2>
      <p>
        <strong>Nom de l'hébergeur :</strong> XYZ Hosting<br />
        <strong>Adresse :</strong> 456 Avenue de l'Hébergement, 69000 Lyon, France<br />
        <strong>Téléphone :</strong> +33 4 56 78 90 12<br />
      ...
      <p>
        Fruitful Coaching Numérique SARL se réserve le droit de modifier les présentes mentions légales à tout moment. Il est donc recommandé aux utilisateurs de consulter régulièrement cette page pour rester informés des éventuelles mises à jour.
      </p>
    </div>
  );
}
